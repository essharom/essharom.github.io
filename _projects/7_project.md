...
**Topics covered:**
- Core network concepts and network-based analysis methods
- Linear and deep learning approaches for multi-omic feature learning
- LLM prompt engineering and fine-tuning techniques for biomedical knowledge

**Links:**
- [ECCB 2026 Tutorial Page](https://eccb2026.org/tutorials-workshops#t8-multi-omics-genedisease-discovery-knowledge-graphs-and-llm-augmented-analysis)
